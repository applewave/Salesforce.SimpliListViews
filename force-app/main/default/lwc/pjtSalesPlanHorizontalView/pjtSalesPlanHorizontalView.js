/****************************************************************************************
 * File Name    : pjtSalesPlanHorizontalView
 * Author       : ar.kim
 * Date         : 2024-07-01
 * Description  :
 ...
 ****************************************************************************************/
 ...
 import init from '@salesforce/apex/PjtSalesPlanHorizontalViewController.init';
 import getSalesPlanItem from '@salesforce/apex/PjtSalesPlanHorizontalViewController.getSalesPlanItem';
 import getSalesPlanDetail from '@salesforce/apex/PjtSalesPlanHorizontalViewController.getSalesPlanDetail';
 import setProjectSalesPlanList from '@salesforce/apex/PjtSalesPlanHorizontalViewController.setProjectSalesPlanList';

export default class PjtSalesPlanHorizontalView extends LightningElement {
    ...
    _renderedData(recordId) {
        console.info('%c==================================== PjtSalesPlanHorizontalViewController.renderedCallback', 'color:red;');
        ...
        init({recordId: recordId}).then(result => {
           ...
           console.log('PjtSalesPlanHorizontalView renderedData ERROR', JSON.stringify(error));
       });
    }
