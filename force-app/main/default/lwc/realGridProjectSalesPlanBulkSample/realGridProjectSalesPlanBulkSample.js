 ...
 ****************************************************************************************/
 ...
 import init from '@salesforce/apex/RealGridProjectSalesPlanBulkController.init';
 import getSalesPlanItem from '@salesforce/apex/RealGridProjectSalesPlanBulkController.getSalesPlanItem';
 import getSalesPlanDetail from '@salesforce/apex/RealGridProjectSalesPlanBulkController.getSalesPlanDetail';
 import setProjectSalesPlanList from '@salesforce/apex/RealGridProjectSalesPlanBulkController.setProjectSalesPlanList';
 ...
 export default class RealGridProjectSalesPlanSample extends LightningElement {
     ...
     renderedCallback() {
         ...
         Promise.all([
            ...
            /*for(let i=0; i<this.result.itemListSize; i++){
                let itemList = [ this.result.itemList[i] ];
                console.log('itemList', itemList);
                setProjectSalesPlanList({itemList: itemList, detailList: this.result.detailList})
                .then(result => {
            ...
            for(let i=0; i<this._dataSize ; i++){ 
                itemList.push(this.result.itemList[i]);
            }
            console.log(this.result.itemList.slice(this._dataSize));
            this.result.itemList = this.result.itemList.slice(this._dataSize);*/
     ...
     _initializeGrid(){
        ...
        //  });
         ...
         this.gridView.onScrollToBottom = function() {
            ...
            console.log(this.result.itemList);
