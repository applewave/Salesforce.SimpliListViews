/****************************************************************************************
 * File Name    : realGridProjectSalesPlanSample
 * Author       : ar.kim
 * Date         : 2024-06-24
 * Description  :
...
import init from '@salesforce/apex/RealGridProjectSalesPlanSampleController.init';
...
export default class RealGridProjectSalesPlanSample extends LightningElement {
    ...
    renderedCallback() {
        ...
        Promise.all([
            ...
            this._recordList = this.result.recordList;
            this._startYear = this.result.pjtStartYear;
            this._term = this.result.pjtTerm;
    ...
    get _columns(){
        ...
        let defaultColumns = [
            ...
            /* 견적제품 전체 수량물량 정보 */
            { name: 'ttlAmt', fieldName: 'ttlAmt', header: { text: 'Amt.',}, groupFooter: { expression: "sum", numberFormat: "#,##0" }, footer: { numberFormat: "#,##0", expression: "sum" }, styleName: "right-column"},
            { name:  'ttlQty', fieldName: 'ttlQty', header: { text: 'Qty',}, groupFooter: { expression: "sum", numberFormat: "#,##0" }, footer: { numberFormat: "#,##0", expression: "sum" }, styleName: "right-column"},
        ...
        for(let i=0; i<this._term; i++){
            ...
            defaultColumns.push(
                { name: 'ttlamt'+yearly, fieldName: 'ttlamt'+yearly, header: { text: 'Amt.',}, groupFooter: { expression: "sum", numberFormat: "#,##0" }, groupFooter: { expression: "sum", numberFormat: "#,##0" }, footer: { numberFormat: "#,##0", expression: "sum" }, styleName: "right-column"},
                { name:  'ttlqty'+yearly, fieldName: 'ttlqty'+yearly, header: { text: 'Qty',}, groupFooter: { expression: "sum", numberFormat: "#,##0" }, groupFooter: { expression: "sum", numberFormat: "#,##0" }, footer: { numberFormat: "#,##0", expression: "sum" }, styleName: "right-column"},
                { name: 'ttlprice'+yearly, fieldName: 'ttlprice'+yearly, header: { text: 'Price',}, styleName: "right-column"},
                { name: 'amt'+yearly+'JAN', fieldName: 'amt'+yearly+'JAN', header: { text: 'Amt.',}, groupFooter: { expression: "sum", numberFormat: "#,##0" }, groupFooter: { expression: "sum", numberFormat: "#,##0" }, footer: { numberFormat: "#,##0", expression: "sum" }, styleName: "right-column"},
                { name:  'qty'+yearly+'JAN', fieldName: 'qty'+yearly+'JAN', header: { text: 'Qty',}, groupFooter: { expression: "sum", numberFormat: "#,##0" }, groupFooter: { expression: "sum", numberFormat: "#,##0" }, footer: { numberFormat: "#,##0", expression: "sum" }, styleName: "right-column"},
                { name: 'price'+yearly+'JAN', fieldName: 'price'+yearly+'JAN', header: { text: 'Price',}, styleName: "right-column"},
                { name: 'amt'+yearly+'FEB', fieldName: 'amt'+yearly+'FEB', header: { text: 'Amt.',}, groupFooter: { expression: "sum", numberFormat: "#,##0" }, groupFooter: { expression: "sum", numberFormat: "#,##0" }, footer: { numberFormat: "#,##0", expression: "sum" }, styleName: "right-column"},
                { name:  'qty'+yearly+'FEB', fieldName: 'qty'+yearly+'FEB', header: { text: 'Qty',}, groupFooter: { expression: "sum", numberFormat: "#,##0" }, groupFooter: { expression: "sum", numberFormat: "#,##0" }, footer: { numberFormat: "#,##0", expression: "sum" }, styleName: "right-column"},
                { name: 'price'+yearly+'FEB', fieldName: 'price'+yearly+'FEB', header: { text: 'Price',}, styleName: "right-column"},
                { name: 'amt'+yearly+'MAR', fieldName: 'amt'+yearly+'MAR', header: { text: 'Amt.',}, groupFooter: { expression: "sum", numberFormat: "#,##0" }, groupFooter: { expression: "sum", numberFormat: "#,##0" }, footer: { numberFormat: "#,##0", expression: "sum" }, styleName: "right-column"},
                { name:  'qty'+yearly+'MAR', fieldName: 'qty'+yearly+'MAR', header: { text: 'Qty',}, groupFooter: { expression: "sum", numberFormat: "#,##0" }, footer: { numberFormat: "#,##0", expression: "sum" }, styleName: "right-column"},
                { name: 'price'+yearly+'MAR', fieldName: 'price'+yearly+'MAR', header: { text: 'Price',}, styleName: "right-column"},
                { name: 'amt'+yearly+'APR', fieldName: 'amt'+yearly+'APR', header: { text: 'Amt.',}, groupFooter: { expression: "sum", numberFormat: "#,##0" }, footer: { numberFormat: "#,##0", expression: "sum" }, styleName: "right-column"},
                { name:  'qty'+yearly+'APR', fieldName: 'qty'+yearly+'APR', header: { text: 'Qty',}, groupFooter: { expression: "sum", numberFormat: "#,##0" }, footer: { numberFormat: "#,##0", expression: "sum" }, styleName: "right-column"},
                { name: 'price'+yearly+'APR', fieldName: 'price'+yearly+'APR', header: { text: 'Price',}, styleName: "right-column"},
                { name: 'amt'+yearly+'MAY', fieldName: 'amt'+yearly+'MAY', header: { text: 'Amt.',}, groupFooter: { expression: "sum", numberFormat: "#,##0" }, footer: { numberFormat: "#,##0", expression: "sum" }, styleName: "right-column"},
                { name:  'qty'+yearly+'MAY', fieldName: 'qty'+yearly+'MAY', header: { text: 'Qty',}, groupFooter: { expression: "sum", numberFormat: "#,##0" }, footer: { numberFormat: "#,##0", expression: "sum" }, styleName: "right-column"},
                { name: 'price'+yearly+'MAY', fieldName: 'price'+yearly+'MAY', header: { text: 'Price',}, styleName: "right-column"},
                { name: 'amt'+yearly+'JUN', fieldName: 'amt'+yearly+'JUN', header: { text: 'Amt.',}, groupFooter: { expression: "sum", numberFormat: "#,##0" }, footer: { numberFormat: "#,##0", expression: "sum" }, styleName: "right-column"},
                { name:  'qty'+yearly+'JUN', fieldName: 'qty'+yearly+'JUN', header: { text: 'Qty',}, groupFooter: { expression: "sum", numberFormat: "#,##0" }, footer: { numberFormat: "#,##0", expression: "sum" }, styleName: "right-column"},
                { name: 'price'+yearly+'JUN', fieldName: 'price'+yearly+'JUN', header: { text: 'Price',}, styleName: "right-column"},
                { name: 'amt'+yearly+'JUL', fieldName: 'amt'+yearly+'JUL', header: { text: 'Amt.',}, groupFooter: { expression: "sum", numberFormat: "#,##0" }, footer: { numberFormat: "#,##0", expression: "sum" }, styleName: "right-column"},
                { name:  'qty'+yearly+'JUL', fieldName: 'qty'+yearly+'JUL', header: { text: 'Qty',}, groupFooter: { expression: "sum", numberFormat: "#,##0" }, footer: { numberFormat: "#,##0", expression: "sum" }, styleName: "right-column"},
                { name: 'price'+yearly+'JUL', fieldName: 'price'+yearly+'JUL', header: { text: 'Price',}, styleName: "right-column"},
                { name: 'amt'+yearly+'AUG', fieldName: 'amt'+yearly+'AUG', header: { text: 'Amt.',}, groupFooter: { expression: "sum", numberFormat: "#,##0" }, footer: { numberFormat: "#,##0", expression: "sum" }, styleName: "right-column"},
                { name:  'qty'+yearly+'AUG', fieldName: 'qty'+yearly+'AUG', header: { text: 'Qty',}, groupFooter: { expression: "sum", numberFormat: "#,##0" }, footer: { numberFormat: "#,##0", expression: "sum" }, styleName: "right-column"},
                { name: 'price'+yearly+'AUG', fieldName: 'price'+yearly+'AUG', header: { text: 'Price',}, styleName: "right-column"},
                { name: 'amt'+yearly+'SEP', fieldName: 'amt'+yearly+'SEP', header: { text: 'Amt.',}, groupFooter: { expression: "sum", numberFormat: "#,##0" }, footer: { numberFormat: "#,##0", expression: "sum" }, styleName: "right-column"},
                { name:  'qty'+yearly+'SEP', fieldName: 'qty'+yearly+'SEP', header: { text: 'Qty',}, groupFooter: { expression: "sum", numberFormat: "#,##0" }, footer: { numberFormat: "#,##0", expression: "sum" }, styleName: "right-column"},
                { name: 'price'+yearly+'SEP', fieldName: 'price'+yearly+'SEP', header: { text: 'Price',}, styleName: "right-column"},
                { name: 'amt'+yearly+'OCT', fieldName: 'amt'+yearly+'OCT', header: { text: 'Amt.',}, groupFooter: { expression: "sum", numberFormat: "#,##0" }, footer: { numberFormat: "#,##0", expression: "sum" }, styleName: "right-column"},
                { name:  'qty'+yearly+'OCT', fieldName: 'qty'+yearly+'OCT', header: { text: 'Qty',}, groupFooter: { expression: "sum", numberFormat: "#,##0" }, footer: { numberFormat: "#,##0", expression: "sum" }, styleName: "right-column"},
                { name: 'price'+yearly+'OCT', fieldName: 'price'+yearly+'OCT', header: { text: 'Price',}, styleName: "right-column"},
                { name: 'amt'+yearly+'NOV', fieldName: 'amt'+yearly+'NOV', header: { text: 'Amt.',}, groupFooter: { expression: "sum", numberFormat: "#,##0" }, footer: { numberFormat: "#,##0", expression: "sum" }, styleName: "right-column"},
                { name:  'qty'+yearly+'NOV', fieldName: 'qty'+yearly+'NOV', header: { text: 'Qty',}, groupFooter: { expression: "sum", numberFormat: "#,##0" }, footer: { numberFormat: "#,##0", expression: "sum" }, styleName: "right-column"},
                { name: 'price'+yearly+'NOV', fieldName: 'price'+yearly+'NOV', header: { text: 'Price',}, styleName: "right-column"},
                { name: 'amt'+yearly+'DEC', fieldName: 'amt'+yearly+'DEC', header: { text: 'Amt.',}, groupFooter: { expression: "sum", numberFormat: "#,##0" }, footer: { numberFormat: "#,##0", expression: "sum" }, styleName: "right-column"},
                { name:  'qty'+yearly+'DEC', fieldName: 'qty'+yearly+'DEC', header: { text: 'Qty',}, groupFooter: { expression: "sum", numberFormat: "#,##0" }, footer: { numberFormat: "#,##0", expression: "sum" }, styleName: "right-column"},
